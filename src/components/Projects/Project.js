...
import tp from "../../Photos/tplandingpage.png";
import Nav from "../Nav";
          ...
          <div className="card-deck  justify-content-md-center ">
            <div className="card text-center slideCard">
              ...
              <div className="card-body cardBody">
                <h5 className="card-title jumboTextTitle projectTitle">
                  Trashplanet
                </h5>
                <p
                ...
                >
                  Trashplanet is an E-Commerce Clothing website, where users can
                  view current items, add to cart, and checkout by utilizing
                  Commerce JS and Stripe. This project is ongoing.
                </p>
                <a
                  target="__blank"
                  href="https://trashplxnet.netlify.app/"
                ...
                <a
                  target="__blank"
                  href="https://github.com/marvinthompson-code/trashplanet"
                  className="btn enter btn-primary"
                >
                  Github
                </a>
            ...
            <div className="card text-center slideCard">
              ...
              <div className="card-body cardBody">
                ...
                >
                  A booking application that is designed to connect musicians
                  with event booking clients utilizing Reactjs and Redux
                  Toolkit.
                </p>
                <a
                  target="__blank"
            ...
            >
              ...
              <div className="card-body cardBody">
                ...
                >
                  "#NowThatsCap" is an educational Black-History Card Game,
                  currently in Beta. Test your cultural knowledge against the
                  clock!
                </p>
                <a
                  target="__blank"
